...
/*CREATE TABLE Compras (
    ...
    FOREIGN KEY (IdProduto) REFERENCES Estoque(IdProduto) -- Substitua "Produtos" e "Id" pelo nome da tabela de produtos e pela chave primária correspondente
);*/
...
/*ALTER TABLE Compras
ADD Endereço DATETIME;*/

/*SELECT*FROM Compras*/

/*UPDATE Compras
SET NomeCliente = 'Gabriel', Endereço = 'Rua Álvaro Alvim ,98'*/
